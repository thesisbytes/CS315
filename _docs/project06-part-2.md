...
![reg-decoder]({{ img_base }}/reg-decoderGG.png)
...
![imm-decoder]({{ img_base }}/imm-decoderGG.png)
...
![sign-extender]({{ img_base }}/sign-extenderGG.png)
...
![top-level-2]({{ img_base }}/top-level-2GG.png)
...
![spreadsheet-1]({{ site.url }}{{ site.baseurl }}/assets/img/project06/spreadsheet-1.png)
...
![inst-decoder-1]({{ img_base }}/inst-decoder-1GG.png)
...
![top-level-3]({{ img_base }}/top-level-3GG.png)
...
![spreadsheet-2]({{ site.url }}{{ site.baseurl }}/assets/img/project06/spreadsheet-2.png)
...
![inst-decoder-2]({{ img_base }}/inst-decoder-2GG.png)
...
![inst-decoder-3]({{ img_base }}/inst-decoder-3GG.png)
